...
public class ShowList extends AppCompatActivity {
    ...
    private List<EarthQuakes> quakes;
    @Override
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < Constants.LIMIT; i++) {
                        ...
                        earthQuake.setMeg(properties.getDouble("magnitude"));
                    ...
                    arrayAdapter = new ArrayAdapter<>(ShowList.this, android.R.layout.simple_list_item_1,
